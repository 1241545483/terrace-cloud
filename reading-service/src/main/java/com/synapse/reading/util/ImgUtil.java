...
//        BufferedImage bdBuffer = ImageIO.read(backdropUrlRead);
        ...
        BufferedImage new0 = ImgUtil.synthesisPicAtXy(bgBuffer, erMinBuffer, 94, 595);// 二维码合并
...
//        BufferedImage bdBuffer = ImageIO.read(backdropUrlRead);
        ...
        BufferedImage new0 = ImgUtil.synthesisPicAtXy(modelUrl, erMinBuffer, 228, 544);// 二维码合并

//        BufferedImage new1 = ImgUtil.synthesisPicAtXy(new0, goodsMinBuffer, 244, 160);// 二维码图合并

        BufferedImage new2 = ImgUtil.synthesisPicAtXy(new0, erbdBuffer, 175, 325);// 背景图合并
...
//        wxNickName = wxNickName+"";
       ...
       BufferedImage txt =  ImgUtil.addTxtAtXy(new2, name2, 1, 1, font30, hui);
        ...
        txt =  ImgUtil.addTxtAtXy(new2, wxNickName, (650 - metrics.stringWidth(wxNickName))  / 2, 290, font30, hui);
