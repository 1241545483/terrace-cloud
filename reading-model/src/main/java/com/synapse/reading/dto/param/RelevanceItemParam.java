 ...
 * @since 2019-01-23
 */
@ApiModel(value = "RelevanceItemParam对象", description = "书籍与目录对应关系")
public class RelevanceItemParam  {

    private RelevanceItem  relevanceItem = new RelevanceItem();

    public RelevanceItemParam(){}

    public RelevanceItemParam(RelevanceItem  relevanceItem){
