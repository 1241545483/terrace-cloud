...
/**
 * <p>
 * ClassStudentMappingParam
 * </p>
 *
 * @author liuguangfu
 * @since 2019-05-28
 */
@ApiModel(value = "ClassStudentMappingParam对象", description = "班级和学生的关系")
public class ClassStudentMappingParam  {

    private ClassStudentMapping  classStudentMapping = new ClassStudentMapping();

    public ClassStudentMappingParam(){}

    public ClassStudentMappingParam(ClassStudentMapping  classStudentMapping){
