 ...
 * @since 2019-06-12
 */
@ApiModel(value = "UserTaskRecordParam对象", description = "任务接受记录")
public class UserTaskRecordParam  {

    private UserTaskRecord  userTaskRecord = new UserTaskRecord();

    public UserTaskRecordParam(){}

    public UserTaskRecordParam(UserTaskRecord  userTaskRecord){
