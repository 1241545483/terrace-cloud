 ...
 * @since 2018-12-25
 */
@ApiModel(value = "MediaCountsParam对象", description = "统计播放量")
public class MediaCountsParam  {

    private MediaCounts  mediaCounts = new MediaCounts();

    public MediaCountsParam(){}

    public MediaCountsParam(MediaCounts  mediaCounts){
