 ...
 * @since 2019-05-28
 */
@ApiModel(value = "WxLoginStateParam对象", description = "")
public class WxLoginStateParam  {

    private WxLoginState  wxLoginState = new WxLoginState();

    public WxLoginStateParam(){}

    public WxLoginStateParam(WxLoginState  wxLoginState){
