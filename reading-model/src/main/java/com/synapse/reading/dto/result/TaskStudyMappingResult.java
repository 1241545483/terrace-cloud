...
/**
 * <p>
 * TaskStudyMappingResult
 * </p>
 *
 * @author liuguangfu
 * @since 2019-06-11
 */
@ApiModel(value = "TaskStudyMappingResult对象", description = "任务和学习课程的关系")
public class TaskStudyMappingResult {

    private TaskStudyMapping  taskStudyMapping = new TaskStudyMapping();

    public TaskStudyMappingResult(){}

    public TaskStudyMappingResult(TaskStudyMapping  taskStudyMapping){
