...
/**
 * <p>
 * TradeOrderDetailParam
 * </p>
 *
 * @author liuguangfu
 * @since 2019-04-10
 */
@ApiModel(value = "TradeOrderDetailParam对象", description = "订单详情")
public class TradeOrderDetailParam  {

    private TradeOrderDetail  tradeOrderDetail = new TradeOrderDetail();

    public TradeOrderDetailParam(){}

    public TradeOrderDetailParam(TradeOrderDetail  tradeOrderDetail){
