...
/**
 * <p>
 * BaseSystemParameterParam
 * </p>
 *
 * @author wangyifan
 * @since 2018-11-20
 */
@ApiModel(value = "BaseSystemParameterParam对象", description = "")
public class BaseSystemParameterParam  {

    private BaseSystemParameter  baseSystemParameter = new BaseSystemParameter();

    public BaseSystemParameterParam(){}

    public BaseSystemParameterParam(BaseSystemParameter  baseSystemParameter){
